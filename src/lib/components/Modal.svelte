...
>
  ...
  >
    <div class="fixed inset-0 bg-gray-500 bg-opacity-75" aria-hidden="true">
      <span class="inline-block align-middle h-1/2 sm:h-screen" aria-hidden="true">&#8203;</span>
      <div
        ...
        <div class="bg-white px-4 pt-2 pb-4 sm:pt-5 sm:p-6 sm:pb-4 dark:bg-slate-800">
          <div class="sm:flex sm:items-start">
            <div class="w-full mt-3 text-center sm:mt-0 sm:mx-4 sm:text-left dark:text-white">
              ...
              <hr class="my-2" />
              <div class="mt-2">
                <h3 class="text-base font-medium">Changelog</h3>
                <h4 class="text-sm font-medium text-left">v1.0.0</h4>
                <div class="flex flex-col mt-2 w-full justify-between text-left">
